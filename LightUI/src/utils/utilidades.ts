export class Utils {
    public static urlHomologacao = 'https://sspoq.light.com.br/XISOAPAdapter/MessageServlet?senderParty=&senderService=URA&receiverParty=&receiverService=&interface=';
    public static urlProducao = 'https://sspop.light.com.br/XISOAPAdapter/MessageServlet?senderParty=&senderService=URA&receiverParty=&receiverService=&interface=';
